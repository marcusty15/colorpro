...
return (
    <>
      ...
      <form className=" m-4 buscador text-center w-100 " role="search">
        <h5 className="h5busc  text-center">¡Hola! Bienvenido al sistema de rastreo de pedidos, por favor ingresa su número de pedido para conocer su estatus:</h5>
        <div class="input-group mb-3">
  <input  onChange={e=>setSearch(e.target.value)} type="number" class="form-control border-primary " placeholder="Numero de pedido" aria-label="Nombre de usuario del destinatario" aria-describedby="button-addon2"/>
  <button onClick={obtenerRecursos} class="btn btn-primary btn-outline-light" type="button" id="button-addon2">Buscar</button>
        ...
        <div className=" w-100 justify-content-center text-center">
           <h3 className="h3contact  ">Si usted tiene alguna duda o no sabes tu numero de pedido, contáctenos haciendo click en el siguiente botón</h3>
